...
st.markdown(
    """
    ---
    Developed by [Shubham B. Patel](https://www.linkedin.com/in/shubham-patel-1045/), PEng, under the guidance of Reservoir Engineering Consultant [Alan Mourgues](https://www.linkedin.com/in/alan-mourgues/), MSc, founder of [CrowdField](https://www.crowdfield.net/).
